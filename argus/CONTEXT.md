...
(D43/D44/D48/D59). D62 round-13 closures: per-origin polarity supersession (an
opposite-polarity attestation from the same (source, via) supersedes the prior; latest
